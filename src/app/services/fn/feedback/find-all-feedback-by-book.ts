...
export function findAllFeedbackByBook(http: HttpClient, rootUrl: string, params: FindAllFeedbackByBook$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponse>> {
